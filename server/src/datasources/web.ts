...
export const fetcher = {
  fetch_json<T>(url: string, validator: z.ZodType<T>, options?: Options): ResultAsync<T, FetchError> {
      return ResultAsync
        .fromPromise(
  ...
  post_json<T, U = unknown>(url: string, body: U, validator: z.ZodType<T>, options?: Options): ResultAsync<T, FetchError> {
